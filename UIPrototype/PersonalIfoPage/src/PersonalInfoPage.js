...
const PersonalInfo = () => {
    ...
    return (
        <>
            <Header className="sub-header" style={{ backgroundColor: '#fff', borderBottom: '1px solid #f0f0f0' }}>
                <div style={{ display: 'flex', alignItems: 'center' }}>
                    <div className="logo" style={{ marginRight: '20px' }}>个人中心</div>
